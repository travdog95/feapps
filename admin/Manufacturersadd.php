...
<div class="custom-control custom-checkbox d-inline-block">
	<input type="checkbox" class="custom-control-input" data-table="Manufacturers" data-field="x_ActiveFlag" name="x_ActiveFlag[]" id="x_ActiveFlag[]_126943" value="1"<?php echo $selwrk ?><?php echo $Manufacturers_add->ActiveFlag->editAttributes() ?>>
	<label class="custom-control-label" for="x_ActiveFlag[]_126943"></label>
</div>
</span>
