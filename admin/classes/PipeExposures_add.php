 ...
 * Page class
 */
class PipeExposures_add extends PipeExposures
{
	...
	// Page object name
	public $PageObjName = "PipeExposures_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("PipeExposureslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "PipeExposuresview.php")
