 ...
 * Page class
 */
class v_WorksheetMasterCategories_list extends v_WorksheetMasterCategories
{
	...
	// Table name
	public $TableName = 'v_WorksheetMasterCategories';

	// Page object name
	public $PageObjName = "v_WorksheetMasterCategories_list";

	// Grid form hidden field names
	public $FormName = "fv_WorksheetMasterCategorieslist";
	...
	public function __construct()
	{
		...
		// Table object (v_WorksheetMasterCategories)
		if (!isset($GLOBALS["v_WorksheetMasterCategories"]) || get_class($GLOBALS["v_WorksheetMasterCategories"]) == PROJECT_NAMESPACE . "v_WorksheetMasterCategories") {
			$GLOBALS["v_WorksheetMasterCategories"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["v_WorksheetMasterCategories"];
		}
		...
		$this->AddUrl = "v_WorksheetMasterCategoriesadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "v_WorksheetMasterCategoriesdelete.php";
		$this->MultiUpdateUrl = "v_WorksheetMasterCategoriesupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'v_WorksheetMasterCategories');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fv_WorksheetMasterCategorieslistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $v_WorksheetMasterCategories;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($v_WorksheetMasterCategories);
				$doc->Text = @$content;
	...
	{
		if ($this->isAddOrEdit())
			$this->Department_Idn->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->Name->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->ShortName->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->FieldUnitPrice->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->IsFitting->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->CartFlag->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->IsShared->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->IsAssembly->Visible = FALSE;
		if ($this->isAddOrEdit())
			$this->ActiveFlag->Visible = FALSE;
	}
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fv_WorksheetMasterCategorieslistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fv_WorksheetMasterCategorieslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv_WorksheetMasterCategorieslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fv_WorksheetMasterCategorieslist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fv_WorksheetMasterCategorieslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fv_WorksheetMasterCategorieslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fv_WorksheetMasterCategorieslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_v_WorksheetMasterCategories" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_v_WorksheetMasterCategories\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fv_WorksheetMasterCategorieslist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
