 ...
 * Page class
 */
class FinishTypes_add extends FinishTypes
{
	...
	// Page object name
	public $PageObjName = "FinishTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("FinishTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "FinishTypesview.php")
