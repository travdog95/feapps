 ...
 * Page class
 */
class HangerSubTypes_edit extends HangerSubTypes
{
	...
	// Page object name
	public $PageObjName = "HangerSubTypes_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("HangerSubType_Idn") !== NULL) {
				...
				$this->HangerSubType_Idn->setOldValue($this->HangerSubType_Idn->QueryStringValue);
			} elseif (Key(0) !== NULL) {
				...
				$this->HangerSubType_Idn->setOldValue($this->HangerSubType_Idn->FormValue);
			} elseif (Route(2) !== NULL) {
				$this->HangerSubType_Idn->setQueryStringValue(Route(2));
				$this->HangerSubType_Idn->setOldValue($this->HangerSubType_Idn->QueryStringValue);
			} else {
			...
			if (Post("action") !== NULL) {
				...
				// Load key from Form
				if ($CurrentForm->hasValue("x_HangerSubType_Idn")) {
					$this->HangerSubType_Idn->setFormValue($CurrentForm->getValue("x_HangerSubType_Idn"));
				}
			} else {
			...
			if ($this->TotalRecords <= 0) { // No record found
				...
				if ($this->HangerSubType_Idn->CurrentValue != NULL) {
					while (!$rs->EOF) {
						if (SameString($this->HangerSubType_Idn->CurrentValue, $rs->fields('HangerSubType_Idn'))) {
		...
		switch ($this->CurrentAction) {
			...
			case "update": // Update
				...
				if (GetPageName($returnUrl) == "HangerSubTypeslist.php")
