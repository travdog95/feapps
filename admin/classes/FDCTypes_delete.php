 ...
 * Page class
 */
class FDCTypes_delete extends FDCTypes
{
	...
	// Page object name
	public $PageObjName = "FDCTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("FDCTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("FDCTypeslist.php"); // Return to list
			}
		}
	}
