 ...
 * Page class
 */
class UndergroundValves_delete extends UndergroundValves
{
	...
	// Page object name
	public $PageObjName = "UndergroundValves_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("UndergroundValveslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("UndergroundValveslist.php"); // Return to list
			}
		}
	}
