 ...
 * Page class
 */
class ProductSizes_delete extends ProductSizes
{
	...
	// Page object name
	public $PageObjName = "ProductSizes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ProductSizeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ProductSizeslist.php"); // Return to list
			}
		}
	}
