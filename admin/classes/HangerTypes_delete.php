 ...
 * Page class
 */
class HangerTypes_delete extends HangerTypes
{
	...
	// Page object name
	public $PageObjName = "HangerTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("HangerTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("HangerTypeslist.php"); // Return to list
			}
		}
	}
