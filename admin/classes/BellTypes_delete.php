 ...
 * Page class
 */
class BellTypes_delete extends BellTypes
{
	...
	// Page object name
	public $PageObjName = "BellTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("BellTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("BellTypeslist.php"); // Return to list
			}
		}
	}
