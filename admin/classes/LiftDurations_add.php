 ...
 * Page class
 */
class LiftDurations_add extends LiftDurations
{
	...
	// Page object name
	public $PageObjName = "LiftDurations_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("LiftDurationslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "LiftDurationsview.php")
