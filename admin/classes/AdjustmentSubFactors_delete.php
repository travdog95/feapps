 ...
 * Page class
 */
class AdjustmentSubFactors_delete extends AdjustmentSubFactors
{
	...
	// Page object name
	public $PageObjName = "AdjustmentSubFactors_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("AdjustmentSubFactorslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("AdjustmentSubFactorslist.php"); // Return to list
			}
		}
	}
