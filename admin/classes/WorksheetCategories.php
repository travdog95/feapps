...
/**
 * Table class for WorksheetCategories
 */
class WorksheetCategories extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'WorksheetCategories';
		$this->TableName = 'WorksheetCategories';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "[dbo].[WorksheetCategories]";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		$this->WorksheetCategory_Idn = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_WorksheetCategory_Idn', 'WorksheetCategory_Idn', '[WorksheetCategory_Idn]', 'CAST([WorksheetCategory_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[WorksheetCategory_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->WorksheetCategory_Idn->IsAutoIncrement = TRUE; // Autoincrement field
		...
		// Name
		$this->Name = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_Name', 'Name', '[Name]', '[Name]', 200, 100, -1, FALSE, '[Name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// ShortName
		$this->ShortName = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_ShortName', 'ShortName', '[ShortName]', '[ShortName]', 200, 30, -1, FALSE, '[ShortName]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShortName->Sortable = TRUE; // Allow sort
		$this->fields['ShortName'] = &$this->ShortName;

		// Department_Idn
		$this->Department_Idn = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_Department_Idn', 'Department_Idn', '[Department_Idn]', 'CAST([Department_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[Department_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// FieldUnitPrice
		$this->FieldUnitPrice = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_FieldUnitPrice', 'FieldUnitPrice', '[FieldUnitPrice]', 'CAST([FieldUnitPrice] AS NVARCHAR)', 131, 8, -1, FALSE, '[FieldUnitPrice]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsFitting
		$this->IsFitting = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_IsFitting', 'IsFitting', '[IsFitting]', '[IsFitting]', 11, 2, -1, FALSE, '[IsFitting]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->IsFitting->Sortable = TRUE; // Allow sort
		$this->IsFitting->DataType = DATATYPE_BOOLEAN;
		$this->IsFitting->Lookup = new Lookup('IsFitting', 'WorksheetCategories', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->IsFitting->OptionCount = 2;
		$this->fields['IsFitting'] = &$this->IsFitting;

		// CartFlag
		$this->CartFlag = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_CartFlag', 'CartFlag', '[CartFlag]', '[CartFlag]', 11, 2, -1, FALSE, '[CartFlag]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->CartFlag->Sortable = TRUE; // Allow sort
		$this->CartFlag->DataType = DATATYPE_BOOLEAN;
		$this->CartFlag->Lookup = new Lookup('CartFlag', 'WorksheetCategories', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->CartFlag->OptionCount = 2;
		$this->fields['CartFlag'] = &$this->CartFlag;

		// IsShared
		$this->IsShared = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_IsShared', 'IsShared', '[IsShared]', '[IsShared]', 11, 2, -1, FALSE, '[IsShared]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->IsShared->Sortable = TRUE; // Allow sort
		$this->IsShared->DataType = DATATYPE_BOOLEAN;
		$this->IsShared->Lookup = new Lookup('IsShared', 'WorksheetCategories', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->IsShared->OptionCount = 2;
		$this->fields['IsShared'] = &$this->IsShared;

		// IsAssembly
		$this->IsAssembly = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_IsAssembly', 'IsAssembly', '[IsAssembly]', '[IsAssembly]', 11, 2, -1, FALSE, '[IsAssembly]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->IsAssembly->Sortable = TRUE; // Allow sort
		$this->IsAssembly->DataType = DATATYPE_BOOLEAN;
		$this->IsAssembly->Lookup = new Lookup('IsAssembly', 'WorksheetCategories', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->IsAssembly->OptionCount = 2;
		$this->fields['IsAssembly'] = &$this->IsAssembly;

		// ActiveFlag
		$this->ActiveFlag = new DbField('WorksheetCategories', 'WorksheetCategories', 'x_ActiveFlag', 'ActiveFlag', '[ActiveFlag]', '[ActiveFlag]', 11, 2, -1, FALSE, '[ActiveFlag]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->ActiveFlag->Sortable = TRUE; // Allow sort
		$this->ActiveFlag->DataType = DATATYPE_BOOLEAN;
		$this->ActiveFlag->Lookup = new Lookup('ActiveFlag', 'WorksheetCategories', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "WorksheetMasterCategories") {
			...
			$detailUrl .= "&fk_WorksheetCategory_Idn=" . urlencode($this->WorksheetCategory_Idn->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "WorksheetCategorieslist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[WorksheetCategories]";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->WorksheetCategory_Idn->setDbValue($conn->insert_ID());
			$rs['WorksheetCategory_Idn'] = $this->WorksheetCategory_Idn->DbValue;
		}
		return $success;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "WorksheetCategorieslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "WorksheetCategoriesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "WorksheetCategoriesadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("WorksheetCategoriesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("WorksheetCategoriesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "WorksheetCategoriesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "WorksheetCategoriesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("WorksheetCategoriesedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("WorksheetCategoriesedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("WorksheetCategoriesadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("WorksheetCategoriesadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("WorksheetCategoriesdelete.php", $this->getUrlParm());
	}
