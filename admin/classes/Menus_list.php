 ...
 * Page class
 */
class Menus_list extends Menus
{
	...
	// Page object name
	public $PageObjName = "Menus_list";

	// Grid form hidden field names
	public $FormName = "fMenuslist";
	...
	public function __construct()
	{
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fMenuslistsrch";
	...
	public function run()
	{
		...
		$this->Menu_Idn->setVisibility();
		$this->Name->setVisibility();
		$this->ShortName->setVisibility();
		$this->Link->setVisibility();
		$this->Icon->setVisibility();
		$this->MenuType_Idn->setVisibility();
		$this->Rank->setVisibility();
		$this->ChildMenuType_Idn->setVisibility();
		$this->IsParent->setVisibility();
		$this->AdminOnly->setVisibility();
		...
		// Set up lookup cache
		$this->setupLookupOptions($this->MenuType_Idn);
		$this->setupLookupOptions($this->ChildMenuType_Idn);
	...
	{
		$this->setKey("Menu_Idn", ""); // Clear inline edit key
	...
	protected function inlineEditMode()
	{
		...
		$inlineEdit = TRUE;
		if (Get("Menu_Idn") !== NULL) {
			$this->Menu_Idn->setQueryStringValue(Get("Menu_Idn"));
		} else {
			$inlineEdit = FALSE;
		}
		if ($inlineEdit) {
			if ($this->loadRow()) {
				$this->setKey("Menu_Idn", $this->Menu_Idn->CurrentValue); // Set up inline edit key
	...
	public function checkInlineEditKey()
	{
		if ($this->EventCancelled)
			$this->Menu_Idn->OldValue = $this->Menu_Idn->DbValue;
		$val = $this->Menu_Idn->OldValue !== NULL ? $this->Menu_Idn->OldValue : $this->Menu_Idn->CurrentValue;
		if (strval($this->getKey("Menu_Idn")) != strval($val))
			return FALSE;
		return TRUE;
	}
	...
	protected function inlineAddMode()
	{
		...
		if ($this->isCopy()) {
			if (Get("Menu_Idn") !== NULL) {
				$this->Menu_Idn->setQueryStringValue(Get("Menu_Idn"));
				$this->setKey("Menu_Idn", $this->Menu_Idn->CurrentValue); // Set up key
			} else {
				$this->setKey("Menu_Idn", ""); // Clear key
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->Menu_Idn->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->Menu_Idn->OldValue))
				return FALSE;
		}
		return TRUE;
	}
		...
		for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
			...
			if (!$this->emptyRow()) {
				...
				if ($gridInsert) {
					...
					$key .= $this->Menu_Idn->CurrentValue;
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_Name") && $CurrentForm->hasValue("o_Name") && $this->Name->CurrentValue != $this->Name->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ShortName") && $CurrentForm->hasValue("o_ShortName") && $this->ShortName->CurrentValue != $this->ShortName->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_Link") && $CurrentForm->hasValue("o_Link") && $this->Link->CurrentValue != $this->Link->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_Icon") && $CurrentForm->hasValue("o_Icon") && $this->Icon->CurrentValue != $this->Icon->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_MenuType_Idn") && $CurrentForm->hasValue("o_MenuType_Idn") && $this->MenuType_Idn->CurrentValue != $this->MenuType_Idn->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_Rank") && $CurrentForm->hasValue("o_Rank") && $this->Rank->CurrentValue != $this->Rank->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ChildMenuType_Idn") && $CurrentForm->hasValue("o_ChildMenuType_Idn") && $this->ChildMenuType_Idn->CurrentValue != $this->ChildMenuType_Idn->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_IsParent") && $CurrentForm->hasValue("o_IsParent") && ConvertToBool($this->IsParent->CurrentValue) != ConvertToBool($this->IsParent->OldValue))
			return FALSE;
		if ($CurrentForm->hasValue("x_AdminOnly") && $CurrentForm->hasValue("o_AdminOnly") && ConvertToBool($this->AdminOnly->CurrentValue) != ConvertToBool($this->AdminOnly->OldValue))
			return FALSE;
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->Menu_Idn->AdvancedSearch->toJson(), ","); // Field Menu_Idn
		...
		$filterList = Concat($filterList, $this->MenuType_Idn->AdvancedSearch->toJson(), ","); // Field MenuType_Idn
		$filterList = Concat($filterList, $this->Rank->AdvancedSearch->toJson(), ","); // Field Rank
		$filterList = Concat($filterList, $this->ChildMenuType_Idn->AdvancedSearch->toJson(), ","); // Field ChildMenuType_Idn
		$filterList = Concat($filterList, $this->IsParent->AdvancedSearch->toJson(), ","); // Field IsParent
		$filterList = Concat($filterList, $this->AdminOnly->AdvancedSearch->toJson(), ","); // Field AdminOnly
	...
	protected function restoreFilterList()
	{
		...
		// Field Menu_Idn
		$this->Menu_Idn->AdvancedSearch->SearchValue = @$filter["x_Menu_Idn"];
		$this->Menu_Idn->AdvancedSearch->SearchOperator = @$filter["z_Menu_Idn"];
		$this->Menu_Idn->AdvancedSearch->SearchCondition = @$filter["v_Menu_Idn"];
		$this->Menu_Idn->AdvancedSearch->SearchValue2 = @$filter["y_Menu_Idn"];
		$this->Menu_Idn->AdvancedSearch->SearchOperator2 = @$filter["w_Menu_Idn"];
		$this->Menu_Idn->AdvancedSearch->save();
		...
		// Field MenuType_Idn
		$this->MenuType_Idn->AdvancedSearch->SearchValue = @$filter["x_MenuType_Idn"];
		$this->MenuType_Idn->AdvancedSearch->SearchOperator = @$filter["z_MenuType_Idn"];
		$this->MenuType_Idn->AdvancedSearch->SearchCondition = @$filter["v_MenuType_Idn"];
		$this->MenuType_Idn->AdvancedSearch->SearchValue2 = @$filter["y_MenuType_Idn"];
		$this->MenuType_Idn->AdvancedSearch->SearchOperator2 = @$filter["w_MenuType_Idn"];
		$this->MenuType_Idn->AdvancedSearch->save();
		...
		// Field ChildMenuType_Idn
		$this->ChildMenuType_Idn->AdvancedSearch->SearchValue = @$filter["x_ChildMenuType_Idn"];
		$this->ChildMenuType_Idn->AdvancedSearch->SearchOperator = @$filter["z_ChildMenuType_Idn"];
		$this->ChildMenuType_Idn->AdvancedSearch->SearchCondition = @$filter["v_ChildMenuType_Idn"];
		$this->ChildMenuType_Idn->AdvancedSearch->SearchValue2 = @$filter["y_ChildMenuType_Idn"];
		$this->ChildMenuType_Idn->AdvancedSearch->SearchOperator2 = @$filter["w_ChildMenuType_Idn"];
		$this->ChildMenuType_Idn->AdvancedSearch->save();

		// Field IsParent
		$this->IsParent->AdvancedSearch->SearchValue = @$filter["x_IsParent"];
		$this->IsParent->AdvancedSearch->SearchOperator = @$filter["z_IsParent"];
		$this->IsParent->AdvancedSearch->SearchCondition = @$filter["v_IsParent"];
		$this->IsParent->AdvancedSearch->SearchValue2 = @$filter["y_IsParent"];
		$this->IsParent->AdvancedSearch->SearchOperator2 = @$filter["w_IsParent"];
		$this->IsParent->AdvancedSearch->save();

		// Field AdminOnly
		$this->AdminOnly->AdvancedSearch->SearchValue = @$filter["x_AdminOnly"];
		$this->AdminOnly->AdvancedSearch->SearchOperator = @$filter["z_AdminOnly"];
		$this->AdminOnly->AdvancedSearch->SearchCondition = @$filter["v_AdminOnly"];
		$this->AdminOnly->AdvancedSearch->SearchValue2 = @$filter["y_AdminOnly"];
		$this->AdminOnly->AdvancedSearch->SearchOperator2 = @$filter["w_AdminOnly"];
		$this->AdminOnly->AdvancedSearch->save();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Menu_Idn); // Menu_Idn
			$this->updateSort($this->Name); // Name
			$this->updateSort($this->ShortName); // ShortName
			$this->updateSort($this->Link); // Link
			$this->updateSort($this->Icon); // Icon
			$this->updateSort($this->MenuType_Idn); // MenuType_Idn
			$this->updateSort($this->Rank); // Rank
			$this->updateSort($this->ChildMenuType_Idn); // ChildMenuType_Idn
			$this->updateSort($this->IsParent); // IsParent
			$this->updateSort($this->AdminOnly); // AdminOnly
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->Menu_Idn->setSort("");
				$this->Name->setSort("");
				$this->ShortName->setSort("");
				$this->Link->setSort("");
				$this->Icon->setSort("");
				$this->MenuType_Idn->setSort("");
				$this->Rank->setSort("");
				$this->ChildMenuType_Idn->setSort("");
				$this->IsParent->setSort("");
				$this->AdminOnly->setSort("");
	...
	public function renderListOptions()
	{
		...
		if ($this->isInlineEditRow()) { // Inline-Edit
			...
			$opt->Body .= "<input type=\"hidden\" name=\"k" . $this->RowIndex . "_key\" id=\"k" . $this->RowIndex . "_key\" value=\"" . HtmlEncode($this->Menu_Idn->CurrentValue) . "\">";
			return;
		}
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->Menu_Idn->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
		if ($this->isGridEdit() && is_numeric($this->RowIndex)) {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $keyName . "\" id=\"" . $keyName . "\" value=\"" . $this->Menu_Idn->CurrentValue . "\">";
		}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.fMenuslist, url:'" . $this->MultiDeleteUrl . "', data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = $Security->canDelete();
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fMenuslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fMenuslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fMenuslist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->MenuType_Idn->CurrentValue = 0;
		$this->MenuType_Idn->OldValue = $this->MenuType_Idn->CurrentValue;
		$this->Rank->CurrentValue = 0;
		$this->Rank->OldValue = $this->Rank->CurrentValue;
		$this->ChildMenuType_Idn->CurrentValue = 0;
		$this->ChildMenuType_Idn->OldValue = $this->ChildMenuType_Idn->CurrentValue;
		$this->IsParent->CurrentValue = 0;
		$this->IsParent->OldValue = $this->IsParent->CurrentValue;
		$this->AdminOnly->CurrentValue = 0;
		$this->AdminOnly->OldValue = $this->AdminOnly->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'Menu_Idn' first before field var 'x_Menu_Idn'
		$val = $CurrentForm->hasValue("Menu_Idn") ? $CurrentForm->getValue("Menu_Idn") : $CurrentForm->getValue("x_Menu_Idn");
		if (!$this->Menu_Idn->IsDetailKey && !$this->isGridAdd() && !$this->isAdd())
			$this->Menu_Idn->setFormValue($val);
		...
		if ($CurrentForm->hasValue("o_ShortName"))
			$this->ShortName->setOldValue($CurrentForm->getValue("o_ShortName"));
		...
		if ($CurrentForm->hasValue("o_Link"))
		...
		if ($CurrentForm->hasValue("o_Icon"))
			$this->Icon->setOldValue($CurrentForm->getValue("o_Icon"));

		// Check field name 'MenuType_Idn' first before field var 'x_MenuType_Idn'
		$val = $CurrentForm->hasValue("MenuType_Idn") ? $CurrentForm->getValue("MenuType_Idn") : $CurrentForm->getValue("x_MenuType_Idn");
		if (!$this->MenuType_Idn->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->MenuType_Idn->Visible = FALSE; // Disable update for API request
			else
				$this->MenuType_Idn->setFormValue($val);
		}
		if ($CurrentForm->hasValue("o_MenuType_Idn"))
			$this->MenuType_Idn->setOldValue($CurrentForm->getValue("o_MenuType_Idn"));
		...
		// Check field name 'ChildMenuType_Idn' first before field var 'x_ChildMenuType_Idn'
		$val = $CurrentForm->hasValue("ChildMenuType_Idn") ? $CurrentForm->getValue("ChildMenuType_Idn") : $CurrentForm->getValue("x_ChildMenuType_Idn");
		if (!$this->ChildMenuType_Idn->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->ChildMenuType_Idn->Visible = FALSE; // Disable update for API request
			else
				$this->ChildMenuType_Idn->setFormValue($val);
		}
		if ($CurrentForm->hasValue("o_ChildMenuType_Idn"))
			$this->ChildMenuType_Idn->setOldValue($CurrentForm->getValue("o_ChildMenuType_Idn"));

		// Check field name 'IsParent' first before field var 'x_IsParent'
		$val = $CurrentForm->hasValue("IsParent") ? $CurrentForm->getValue("IsParent") : $CurrentForm->getValue("x_IsParent");
		if (!$this->IsParent->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->IsParent->Visible = FALSE; // Disable update for API request
			else
				$this->IsParent->setFormValue($val);
		}
		if ($CurrentForm->hasValue("o_IsParent"))
			$this->IsParent->setOldValue($CurrentForm->getValue("o_IsParent"));

		// Check field name 'AdminOnly' first before field var 'x_AdminOnly'
		$val = $CurrentForm->hasValue("AdminOnly") ? $CurrentForm->getValue("AdminOnly") : $CurrentForm->getValue("x_AdminOnly");
		if (!$this->AdminOnly->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->AdminOnly->Visible = FALSE; // Disable update for API request
			else
				$this->AdminOnly->setFormValue($val);
		}
		if ($CurrentForm->hasValue("o_AdminOnly"))
			$this->AdminOnly->setOldValue($CurrentForm->getValue("o_AdminOnly"));
	...
	public function restoreFormValues()
	{
		...
		if (!$this->isGridAdd() && !$this->isAdd())
			$this->Menu_Idn->CurrentValue = $this->Menu_Idn->FormValue;
		...
		$this->MenuType_Idn->CurrentValue = $this->MenuType_Idn->FormValue;
		$this->Rank->CurrentValue = $this->Rank->FormValue;
		$this->ChildMenuType_Idn->CurrentValue = $this->ChildMenuType_Idn->FormValue;
		$this->IsParent->CurrentValue = $this->IsParent->FormValue;
		$this->AdminOnly->CurrentValue = $this->AdminOnly->FormValue;
	...
	public function loadRowValues($rs = NULL)
	{
		...
		if (!$rs || $rs->EOF)
			return;
		$this->Menu_Idn->setDbValue($row['Menu_Idn']);
		$this->Name->setDbValue($row['Name']);
		$this->ShortName->setDbValue($row['ShortName']);
		$this->Link->setDbValue($row['Link']);
		$this->Icon->setDbValue($row['Icon']);
		$this->MenuType_Idn->setDbValue($row['MenuType_Idn']);
		$this->Rank->setDbValue($row['Rank']);
		$this->ChildMenuType_Idn->setDbValue($row['ChildMenuType_Idn']);
		$this->IsParent->setDbValue((ConvertToBool($row['IsParent']) ? "1" : "0"));
		$this->AdminOnly->setDbValue((ConvertToBool($row['AdminOnly']) ? "1" : "0"));
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['Menu_Idn'] = $this->Menu_Idn->CurrentValue;
		$row['Name'] = $this->Name->CurrentValue;
		$row['ShortName'] = $this->ShortName->CurrentValue;
		$row['Link'] = $this->Link->CurrentValue;
		$row['Icon'] = $this->Icon->CurrentValue;
		$row['MenuType_Idn'] = $this->MenuType_Idn->CurrentValue;
		$row['Rank'] = $this->Rank->CurrentValue;
		$row['ChildMenuType_Idn'] = $this->ChildMenuType_Idn->CurrentValue;
		$row['IsParent'] = $this->IsParent->CurrentValue;
		$row['AdminOnly'] = $this->AdminOnly->CurrentValue;
	...
	protected function loadOldRecord()
	{
		...
		$validKey = TRUE;
		if (strval($this->getKey("Menu_Idn")) != "")
			$this->Menu_Idn->OldValue = $this->getKey("Menu_Idn"); // Menu_Idn
		else
			$validKey = FALSE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$curVal = trim(strval($this->MenuType_Idn->CurrentValue));
			if ($curVal != "")
				$this->MenuType_Idn->ViewValue = $this->MenuType_Idn->lookupCacheOption($curVal);
			else
				$this->MenuType_Idn->ViewValue = $this->MenuType_Idn->Lookup !== NULL && is_array($this->MenuType_Idn->Lookup->Options) ? $curVal : NULL;
			if ($this->MenuType_Idn->ViewValue !== NULL) { // Load from cache
				$this->MenuType_Idn->EditValue = array_values($this->MenuType_Idn->Lookup->Options);
			} else { // Lookup from database
				if ($curVal == "") {
					$filterWrk = "0=1";
				} else {
					$filterWrk = "[MenuType_Idn]" . SearchString("=", $this->MenuType_Idn->CurrentValue, DATATYPE_NUMBER, "");
				}
				$lookupFilter = function() {
					return "[ActiveFlag] = 1";
				};
				$lookupFilter = $lookupFilter->bindTo($this);
				$sqlWrk = $this->MenuType_Idn->Lookup->getSql(TRUE, $filterWrk, $lookupFilter, $this);
				$rswrk = Conn()->execute($sqlWrk);
				$arwrk = $rswrk ? $rswrk->getRows() : [];
				if ($rswrk)
					$rswrk->close();
				$this->MenuType_Idn->EditValue = $arwrk;
			}
			...
			$curVal = trim(strval($this->ChildMenuType_Idn->CurrentValue));
			if ($curVal != "")
				$this->ChildMenuType_Idn->ViewValue = $this->ChildMenuType_Idn->lookupCacheOption($curVal);
			else
				$this->ChildMenuType_Idn->ViewValue = $this->ChildMenuType_Idn->Lookup !== NULL && is_array($this->ChildMenuType_Idn->Lookup->Options) ? $curVal : NULL;
			if ($this->ChildMenuType_Idn->ViewValue !== NULL) { // Load from cache
				$this->ChildMenuType_Idn->EditValue = array_values($this->ChildMenuType_Idn->Lookup->Options);
			} else { // Lookup from database
				if ($curVal == "") {
					$filterWrk = "0=1";
				} else {
					$filterWrk = "[MenuType_Idn]" . SearchString("=", $this->ChildMenuType_Idn->CurrentValue, DATATYPE_NUMBER, "");
				}
				$lookupFilter = function() {
					return "[ActiveFlag] = 1";
				};
				$lookupFilter = $lookupFilter->bindTo($this);
				$sqlWrk = $this->ChildMenuType_Idn->Lookup->getSql(TRUE, $filterWrk, $lookupFilter, $this);
				$rswrk = Conn()->execute($sqlWrk);
				$arwrk = $rswrk ? $rswrk->getRows() : [];
				if ($rswrk)
					$rswrk->close();
				$this->ChildMenuType_Idn->EditValue = $arwrk;
			}
	...
	protected function validateForm()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return ($FormError == "");
		if ($this->Menu_Idn->Required) {
			if (!$this->Menu_Idn->IsDetailKey && $this->Menu_Idn->FormValue != NULL && $this->Menu_Idn->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->Menu_Idn->caption(), $this->Menu_Idn->RequiredErrorMessage));
			}
		}
		...
		if ($this->MenuType_Idn->Required) {
			if (!$this->MenuType_Idn->IsDetailKey && $this->MenuType_Idn->FormValue != NULL && $this->MenuType_Idn->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->MenuType_Idn->caption(), $this->MenuType_Idn->RequiredErrorMessage));
			}
		}
		...
		if ($this->ChildMenuType_Idn->Required) {
			if (!$this->ChildMenuType_Idn->IsDetailKey && $this->ChildMenuType_Idn->FormValue != NULL && $this->ChildMenuType_Idn->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->ChildMenuType_Idn->caption(), $this->ChildMenuType_Idn->RequiredErrorMessage));
			}
		}
		if ($this->IsParent->Required) {
			if ($this->IsParent->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->IsParent->caption(), $this->IsParent->RequiredErrorMessage));
			}
		}
		if ($this->AdminOnly->Required) {
			if ($this->AdminOnly->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->AdminOnly->caption(), $this->AdminOnly->RequiredErrorMessage));
			}
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// MenuType_Idn
			$this->MenuType_Idn->setDbValueDef($rsnew, $this->MenuType_Idn->CurrentValue, NULL, $this->MenuType_Idn->ReadOnly);

			// Rank
			$this->Rank->setDbValueDef($rsnew, $this->Rank->CurrentValue, NULL, $this->Rank->ReadOnly);

			// ChildMenuType_Idn
			$this->ChildMenuType_Idn->setDbValueDef($rsnew, $this->ChildMenuType_Idn->CurrentValue, NULL, $this->ChildMenuType_Idn->ReadOnly);

			// IsParent
			$tmpBool = $this->IsParent->CurrentValue;
			if ($tmpBool != "1" && $tmpBool != "0")
				$tmpBool = !empty($tmpBool) ? "1" : "0";
			$this->IsParent->setDbValueDef($rsnew, $tmpBool, NULL, $this->IsParent->ReadOnly);

			// AdminOnly
			$tmpBool = $this->AdminOnly->CurrentValue;
			if ($tmpBool != "1" && $tmpBool != "0")
				$tmpBool = !empty($tmpBool) ? "1" : "0";
			$this->AdminOnly->setDbValueDef($rsnew, $tmpBool, NULL, $this->AdminOnly->ReadOnly);
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('ShortName')); // ShortName
		$hash .= GetFieldHash($rs->fields('Link')); // Link
		$hash .= GetFieldHash($rs->fields('Icon')); // Icon
		$hash .= GetFieldHash($rs->fields('MenuType_Idn')); // MenuType_Idn
		$hash .= GetFieldHash($rs->fields('Rank')); // Rank
		$hash .= GetFieldHash($rs->fields('ChildMenuType_Idn')); // ChildMenuType_Idn
		$hash .= GetFieldHash($rs->fields('IsParent')); // IsParent
		$hash .= GetFieldHash($rs->fields('AdminOnly')); // AdminOnly
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Link
		$this->Link->setDbValueDef($rsnew, $this->Link->CurrentValue, NULL, strval($this->Link->CurrentValue) == "");

		// Icon
		$this->Icon->setDbValueDef($rsnew, $this->Icon->CurrentValue, NULL, FALSE);

		// MenuType_Idn
		$this->MenuType_Idn->setDbValueDef($rsnew, $this->MenuType_Idn->CurrentValue, NULL, strval($this->MenuType_Idn->CurrentValue) == "");

		// Rank
		$this->Rank->setDbValueDef($rsnew, $this->Rank->CurrentValue, NULL, strval($this->Rank->CurrentValue) == "");

		// ChildMenuType_Idn
		$this->ChildMenuType_Idn->setDbValueDef($rsnew, $this->ChildMenuType_Idn->CurrentValue, NULL, strval($this->ChildMenuType_Idn->CurrentValue) == "");

		// IsParent
		$tmpBool = $this->IsParent->CurrentValue;
		if ($tmpBool != "1" && $tmpBool != "0")
			$tmpBool = !empty($tmpBool) ? "1" : "0";
		$this->IsParent->setDbValueDef($rsnew, $tmpBool, NULL, strval($this->IsParent->CurrentValue) == "");

		// AdminOnly
		$tmpBool = $this->AdminOnly->CurrentValue;
		if ($tmpBool != "1" && $tmpBool != "0")
			$tmpBool = !empty($tmpBool) ? "1" : "0";
		$this->AdminOnly->setDbValueDef($rsnew, $tmpBool, NULL, strval($this->AdminOnly->CurrentValue) == "");
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fMenuslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fMenuslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fMenuslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_Menus" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_Menus\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fMenuslist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fMenuslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
