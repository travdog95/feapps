 ...
 * Page class
 */
class JobDefaults_delete extends JobDefaults
{
	...
	// Page object name
	public $PageObjName = "JobDefaults_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("JobDefaultslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("JobDefaultslist.php"); // Return to list
			}
		}
	}
