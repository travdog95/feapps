 ...
 * Page class
 */
class WorksheetMasterSizes_grid extends WorksheetMasterSizes
{
	...
	// Page object name
	public $PageObjName = "WorksheetMasterSizes_grid";

	// Grid form hidden field names
	public $FormName = "fWorksheetMasterSizesgrid";
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 2) {
			if (strval($keys[0]) != "")
				...
				$validKey = FALSE;
			if (strval($keys[1]) != "")
				$this->ProductSize_Idn->OldValue = strval($keys[1]); // ProductSize_Idn
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
