 ...
 * Page class
 */
class HangerTypes_add extends HangerTypes
{
	...
	// Page object name
	public $PageObjName = "HangerTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("HangerTypeslist.php"); // No matching record, return to list
				}
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "HangerTypesview.php")
	...
	protected function validateForm()
	{
		...
		if (in_array("HangerSubTypes", $detailTblVar) && $GLOBALS["HangerSubTypes"]->DetailAdd) {
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($addRow) {
			$detailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("HangerSubTypes", $detailTblVar) && $GLOBALS["HangerSubTypes"]->DetailAdd) {
				$GLOBALS["HangerSubTypes"]->HangerType_Idn->setSessionValue($this->HangerType_Idn->CurrentValue); // Set master key
				if (!isset($GLOBALS["HangerSubTypes_grid"]))
					$GLOBALS["HangerSubTypes_grid"] = new HangerSubTypes_grid(); // Get detail page object
				$Security->loadCurrentUserLevel($this->ProjectID . "HangerSubTypes"); // Load user level of detail table
				$addRow = $GLOBALS["HangerSubTypes_grid"]->gridInsert();
				$Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$addRow) {
					$GLOBALS["HangerSubTypes"]->HangerType_Idn->setSessionValue(""); // Clear master key if insert failed
				}
			}
		}
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("HangerSubTypes", $detailTblVar)) {
				...
				if ($GLOBALS["HangerSubTypes_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["HangerSubTypes_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["HangerSubTypes_grid"]->CurrentMode = "add";
					$GLOBALS["HangerSubTypes_grid"]->CurrentAction = "gridadd";
