 ...
 * Page class
 */
class EngineeringAdditionalCosts_delete extends EngineeringAdditionalCosts
{
	...
	// Page object name
	public $PageObjName = "EngineeringAdditionalCosts_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("EngineeringAdditionalCostslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("EngineeringAdditionalCostslist.php"); // Return to list
			}
		}
	}
