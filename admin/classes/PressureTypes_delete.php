 ...
 * Page class
 */
class PressureTypes_delete extends PressureTypes
{
	...
	// Page object name
	public $PageObjName = "PressureTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("PressureTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("PressureTypeslist.php"); // Return to list
			}
		}
	}
