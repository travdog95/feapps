 ...
 * Page class
 */
class TappingTees_delete extends TappingTees
{
	...
	// Page object name
	public $PageObjName = "TappingTees_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("TappingTeeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("TappingTeeslist.php"); // Return to list
			}
		}
	}
