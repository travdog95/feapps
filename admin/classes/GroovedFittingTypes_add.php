 ...
 * Page class
 */
class GroovedFittingTypes_add extends GroovedFittingTypes
{
	...
	// Page object name
	public $PageObjName = "GroovedFittingTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("GroovedFittingTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "GroovedFittingTypesview.php")
