 ...
 * Page class
 */
class WorksheetMasterSizes_delete extends WorksheetMasterSizes
{
	...
	// Page object name
	public $PageObjName = "WorksheetMasterSizes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("WorksheetMasterSizeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("WorksheetMasterSizeslist.php"); // Return to list
			}
		}
	}
