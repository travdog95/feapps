 ...
 * Page class
 */
class ShopFabrications_add extends ShopFabrications
{
	...
	// Page object name
	public $PageObjName = "ShopFabrications_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ShopFabricationslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ShopFabricationsview.php")
