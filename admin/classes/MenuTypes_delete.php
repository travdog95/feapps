 ...
 * Page class
 */
class MenuTypes_delete extends MenuTypes
{
	...
	// Page object name
	public $PageObjName = "MenuTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("MenuTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("MenuTypeslist.php"); // Return to list
			}
		}
	}
