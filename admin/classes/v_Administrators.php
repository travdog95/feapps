...
/**
 * Table class for v_Administrators
 */
class v_Administrators extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_Administrators';
		$this->TableName = 'v_Administrators';
		$this->TableType = 'VIEW';
		...
		// User_Idn
		$this->User_Idn = new DbField('v_Administrators', 'v_Administrators', 'x_User_Idn', 'User_Idn', '[User_Idn]', 'CAST([User_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[User_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// FirstName
		$this->FirstName = new DbField('v_Administrators', 'v_Administrators', 'x_FirstName', 'FirstName', '[FirstName]', '[FirstName]', 200, 30, -1, FALSE, '[FirstName]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FirstName->Sortable = TRUE; // Allow sort
		$this->fields['FirstName'] = &$this->FirstName;

		// LastName
		$this->LastName = new DbField('v_Administrators', 'v_Administrators', 'x_LastName', 'LastName', '[LastName]', '[LastName]', 200, 50, -1, FALSE, '[LastName]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LastName->Sortable = TRUE; // Allow sort
		$this->fields['LastName'] = &$this->LastName;

		// UserName
		$this->UserName = new DbField('v_Administrators', 'v_Administrators', 'x_UserName', 'UserName', '[UserName]', '[UserName]', 200, 16, -1, FALSE, '[UserName]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UserName->Required = TRUE; // Required field
		$this->UserName->Sortable = TRUE; // Allow sort
		$this->fields['UserName'] = &$this->UserName;

		// Email
		$this->_Email = new DbField('v_Administrators', 'v_Administrators', 'x__Email', 'Email', '[Email]', '[Email]', 200, 100, -1, FALSE, '[Email]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Email->Sortable = TRUE; // Allow sort
		$this->fields['Email'] = &$this->_Email;

		// Password
		$this->Password = new DbField('v_Administrators', 'v_Administrators', 'x_Password', 'Password', '[Password]', '[Password]', 200, 16, -1, FALSE, '[Password]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Password->Required = TRUE; // Required field
		$this->Password->Sortable = TRUE; // Allow sort
		$this->fields['Password'] = &$this->Password;

		// IsContractor
		$this->IsContractor = new DbField('v_Administrators', 'v_Administrators', 'x_IsContractor', 'IsContractor', '[IsContractor]', '[IsContractor]', 11, 2, -1, FALSE, '[IsContractor]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->IsContractor->Sortable = TRUE; // Allow sort
		$this->IsContractor->DataType = DATATYPE_BOOLEAN;
		$this->IsContractor->Lookup = new Lookup('IsContractor', 'v_Administrators', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->IsContractor->OptionCount = 2;
		$this->fields['IsContractor'] = &$this->IsContractor;

		// IsAdmin
		$this->IsAdmin = new DbField('v_Administrators', 'v_Administrators', 'x_IsAdmin', 'IsAdmin', '[IsAdmin]', '[IsAdmin]', 11, 2, -1, FALSE, '[IsAdmin]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->IsAdmin->Sortable = TRUE; // Allow sort
		$this->IsAdmin->DataType = DATATYPE_BOOLEAN;
		$this->IsAdmin->Lookup = new Lookup('IsAdmin', 'v_Administrators', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->IsAdmin->OptionCount = 2;
		$this->fields['IsAdmin'] = &$this->IsAdmin;

		// Department_Idn
		$this->Department_Idn = new DbField('v_Administrators', 'v_Administrators', 'x_Department_Idn', 'Department_Idn', '[Department_Idn]', 'CAST([Department_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[Department_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActiveFlag
		$this->ActiveFlag = new DbField('v_Administrators', 'v_Administrators', 'x_ActiveFlag', 'ActiveFlag', '[ActiveFlag]', '[ActiveFlag]', 11, 2, -1, FALSE, '[ActiveFlag]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->ActiveFlag->Sortable = TRUE; // Allow sort
		$this->ActiveFlag->DataType = DATATYPE_BOOLEAN;
		$this->ActiveFlag->Lookup = new Lookup('ActiveFlag', 'v_Administrators', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[v_Administrators]";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "v_Administratorslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v_Administratorsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_Administratorsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_Administratorsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_Administratorsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_Administratorsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_Administratorsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_Administratorsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_Administratorsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_Administratorsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_Administratorsdelete.php", $this->getUrlParm());
	}
