 ...
 * Page class
 */
class PipeLengths_delete extends PipeLengths
{
	...
	// Page object name
	public $PageObjName = "PipeLengths_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("PipeLengthslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("PipeLengthslist.php"); // Return to list
			}
		}
	}
