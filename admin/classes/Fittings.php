...
/**
 * Table class for Fittings
 */
class Fittings extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'Fittings';
		$this->TableName = 'Fittings';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "[dbo].[Fittings]";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// Fitting_Idn
		$this->Fitting_Idn = new DbField('Fittings', 'Fittings', 'x_Fitting_Idn', 'Fitting_Idn', '[Fitting_Idn]', 'CAST([Fitting_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[Fitting_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->Fitting_Idn->IsAutoIncrement = TRUE; // Autoincrement field
		$this->Fitting_Idn->IsPrimaryKey = TRUE; // Primary key field
		$this->Fitting_Idn->Nullable = FALSE; // NOT NULL field
		...
		// Name
		$this->Name = new DbField('Fittings', 'Fittings', 'x_Name', 'Name', '[Name]', '[Name]', 200, 100, -1, FALSE, '[Name]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// Department_Idn
		$this->Department_Idn = new DbField('Fittings', 'Fittings', 'x_Department_Idn', 'Department_Idn', '[Department_Idn]', 'CAST([Department_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[Department_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// WorksheetMaster_Idn
		$this->WorksheetMaster_Idn = new DbField('Fittings', 'Fittings', 'x_WorksheetMaster_Idn', 'WorksheetMaster_Idn', '[WorksheetMaster_Idn]', 'CAST([WorksheetMaster_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[WorksheetMaster_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->WorksheetMaster_Idn->Lookup = new Lookup('WorksheetMaster_Idn', 'WorksheetMasters', FALSE, 'WorksheetMaster_Idn', ["Name","","",""], ["x_Department_Idn"], ["x_WorksheetCategory_Idn"], ["Department_Idn"], ["x_Department_Idn"], [], [], '[Rank] ASC', '');
		...
		$this->WorksheetCategory_Idn = new DbField('Fittings', 'Fittings', 'x_WorksheetCategory_Idn', 'WorksheetCategory_Idn', '[WorksheetCategory_Idn]', 'CAST([WorksheetCategory_Idn] AS NVARCHAR)', 3, 4, -1, FALSE, '[WorksheetCategory_Idn]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->WorksheetCategory_Idn->Lookup = new Lookup('WorksheetCategory_Idn', 'v_WorksheetMasterCategories', FALSE, 'WorksheetCategory_Idn', ["Name","","",""], ["x_WorksheetMaster_Idn"], [], ["WorksheetMaster_Idn"], ["x_WorksheetMaster_Idn"], [], [], '[Name] ASC', '');
		...
		// PartOfSetFlag
		$this->PartOfSetFlag = new DbField('Fittings', 'Fittings', 'x_PartOfSetFlag', 'PartOfSetFlag', '[PartOfSetFlag]', '[PartOfSetFlag]', 11, 2, -1, FALSE, '[PartOfSetFlag]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->PartOfSetFlag->Sortable = TRUE; // Allow sort
		$this->PartOfSetFlag->DataType = DATATYPE_BOOLEAN;
		$this->PartOfSetFlag->Lookup = new Lookup('PartOfSetFlag', 'Fittings', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->PartOfSetFlag->OptionCount = 2;
		$this->fields['PartOfSetFlag'] = &$this->PartOfSetFlag;

		// Rank
		$this->Rank = new DbField('Fittings', 'Fittings', 'x_Rank', 'Rank', '[Rank]', 'CAST([Rank] AS NVARCHAR)', 3, 4, -1, FALSE, '[Rank]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActiveFlag
		$this->ActiveFlag = new DbField('Fittings', 'Fittings', 'x_ActiveFlag', 'ActiveFlag', '[ActiveFlag]', '[ActiveFlag]', 11, 2, -1, FALSE, '[ActiveFlag]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->ActiveFlag->Sortable = TRUE; // Allow sort
		$this->ActiveFlag->DataType = DATATYPE_BOOLEAN;
		$this->ActiveFlag->Lookup = new Lookup('ActiveFlag', 'Fittings', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[Fittings]";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "[Department_Idn] ASC,[WorksheetMaster_Idn] ASC,[WorksheetCategory_Idn] ASC,[Rank] ASC";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->Fitting_Idn->setDbValue($conn->insert_ID());
			$rs['Fitting_Idn'] = $this->Fitting_Idn->DbValue;
		}
		return $success;
	}
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if (is_array($where))
			$where = $this->arrayToFilter($where);
		if ($rs) {
			if (array_key_exists('Fitting_Idn', $rs))
				AddFilter($where, QuotedName('Fitting_Idn', $this->Dbid) . '=' . QuotedValue($rs['Fitting_Idn'], $this->Fitting_Idn->DataType, $this->Dbid));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		AddFilter($filter, $where);
		if ($filter != "")
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->PartOfSetFlag->DbValue = (ConvertToBool($row['PartOfSetFlag']) ? "1" : "0");
	...
	{
		return "[Fitting_Idn] = @Fitting_Idn@";
	}
	...
	public function getRecordFilter($row = NULL)
	{
		...
		if (is_array($row))
			$val = array_key_exists('Fitting_Idn', $row) ? $row['Fitting_Idn'] : NULL;
		else
		...
		if ($val == NULL)
			...
			$keyFilter = str_replace("@Fitting_Idn@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		return $keyFilter;
	}
	...
	{
		global $Language;
		if ($pageName == "Fittingsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "Fittingsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "Fittingsadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("Fittingsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("Fittingsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "Fittingsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "Fittingsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("Fittingsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("Fittingsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("Fittingsdelete.php", $this->getUrlParm());
	}
	...
	{
		$json = "";
		$json .= "Fitting_Idn:" . JsonEncode($this->Fitting_Idn->CurrentValue, "number");
		$json = "{" . $json . "}";
		if ($htmlEncode)
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($parm != "")
			$url .= $parm . "&";
		if ($this->Fitting_Idn->CurrentValue != NULL) {
			$url .= "Fitting_Idn=" . urlencode($this->Fitting_Idn->CurrentValue);
		} else {
	...
	public function getRecordKeys()
	{
		...
		if (Param("key_m") !== NULL) {
			...
			if (Param("Fitting_Idn") !== NULL)
				$arKeys[] = Param("Fitting_Idn");
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->Fitting_Idn->CurrentValue = $key;
			else
				$this->Fitting_Idn->OldValue = $key;
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->PartOfSetFlag->setDbValue(ConvertToBool($rs->fields('PartOfSetFlag')) ? "1" : "0");
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->PartOfSetFlag);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->PartOfSetFlag);
