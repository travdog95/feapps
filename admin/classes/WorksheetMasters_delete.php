 ...
 * Page class
 */
class WorksheetMasters_delete extends WorksheetMasters
{
	...
	// Page object name
	public $PageObjName = "WorksheetMasters_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("WorksheetMasterslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("WorksheetMasterslist.php"); // Return to list
			}
		}
	}
