 ...
 * Page class
 */
class ThreadedFittingTypes_delete extends ThreadedFittingTypes
{
	...
	// Page object name
	public $PageObjName = "ThreadedFittingTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ThreadedFittingTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ThreadedFittingTypeslist.php"); // Return to list
			}
		}
	}
