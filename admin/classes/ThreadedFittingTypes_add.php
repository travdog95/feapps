 ...
 * Page class
 */
class ThreadedFittingTypes_add extends ThreadedFittingTypes
{
	...
	// Page object name
	public $PageObjName = "ThreadedFittingTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ThreadedFittingTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ThreadedFittingTypesview.php")
