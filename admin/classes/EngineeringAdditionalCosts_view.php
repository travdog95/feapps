 ...
 * Page class
 */
class EngineeringAdditionalCosts_view extends EngineeringAdditionalCosts
{
	...
	// Page object name
	public $PageObjName = "EngineeringAdditionalCosts_view";
	...
	public function __construct()
	{
		...
		if (Get("EngineeringAdditionalCost_Idn") !== NULL) {
			$this->RecKey["EngineeringAdditionalCost_Idn"] = Get("EngineeringAdditionalCost_Idn");
			$keyUrl .= "&amp;EngineeringAdditionalCost_Idn=" . urlencode($this->RecKey["EngineeringAdditionalCost_Idn"]);
		}
	...
	public function run()
	{
		...
		if (Get("EngineeringAdditionalCost_Idn") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("EngineeringAdditionalCost_Idn");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("EngineeringAdditionalCost_Idn") !== NULL) {
				...
				$this->RecKey["EngineeringAdditionalCost_Idn"] = $this->EngineeringAdditionalCost_Idn->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->EngineeringAdditionalCost_Idn->setQueryStringValue(Key(0));
				$this->RecKey["EngineeringAdditionalCost_Idn"] = $this->EngineeringAdditionalCost_Idn->QueryStringValue;
			} elseif (Post("EngineeringAdditionalCost_Idn") !== NULL) {
				$this->EngineeringAdditionalCost_Idn->setFormValue(Post("EngineeringAdditionalCost_Idn"));
				$this->RecKey["EngineeringAdditionalCost_Idn"] = $this->EngineeringAdditionalCost_Idn->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->EngineeringAdditionalCost_Idn->setFormValue(Route(2));
				$this->RecKey["EngineeringAdditionalCost_Idn"] = $this->EngineeringAdditionalCost_Idn->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecords <= 0) { // No record found
						...
						$this->terminate("EngineeringAdditionalCostslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (SameString($this->EngineeringAdditionalCost_Idn->CurrentValue, $this->Recordset->fields('EngineeringAdditionalCost_Idn'))) {
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "EngineeringAdditionalCostslist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "EngineeringAdditionalCostslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	{
		$row = [];
		$row['EngineeringAdditionalCost_Idn'] = NULL;
		$row['LineNumber'] = NULL;
		$row['Quantity'] = NULL;
		$row['Name'] = NULL;
		$row['ManHours'] = NULL;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fEngineeringAdditionalCostsview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fEngineeringAdditionalCostsview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fEngineeringAdditionalCostsview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
