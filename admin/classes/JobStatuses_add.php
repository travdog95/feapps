 ...
 * Page class
 */
class JobStatuses_add extends JobStatuses
{
	...
	// Page object name
	public $PageObjName = "JobStatuses_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("JobStatuseslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "JobStatusesview.php")
