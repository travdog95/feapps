 ...
 * Page class
 */
class RecapTotalCategories_add extends RecapTotalCategories
{
	...
	// Page object name
	public $PageObjName = "RecapTotalCategories_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("RecapTotalCategorieslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "RecapTotalCategoriesview.php")
