 ...
 * Page class
 */
class JobDefaultTypes_add extends JobDefaultTypes
{
	...
	// Page object name
	public $PageObjName = "JobDefaultTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("JobDefaultTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "JobDefaultTypesview.php")
