 ...
 * Page class
 */
class GroovedFittingTypes_delete extends GroovedFittingTypes
{
	...
	// Page object name
	public $PageObjName = "GroovedFittingTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("GroovedFittingTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("GroovedFittingTypeslist.php"); // Return to list
			}
		}
	}
