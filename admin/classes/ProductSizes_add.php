 ...
 * Page class
 */
class ProductSizes_add extends ProductSizes
{
	...
	// Page object name
	public $PageObjName = "ProductSizes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ProductSizeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ProductSizesview.php")
