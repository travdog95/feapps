 ...
 * Page class
 */
class LiftDurations_delete extends LiftDurations
{
	...
	// Page object name
	public $PageObjName = "LiftDurations_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("LiftDurationslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("LiftDurationslist.php"); // Return to list
			}
		}
	}
