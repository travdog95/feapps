 ...
 * Page class
 */
class HangerSubTypes_delete extends HangerSubTypes
{
	...
	// Page object name
	public $PageObjName = "HangerSubTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("HangerSubTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("HangerSubTypeslist.php"); // Return to list
			}
		}
	}
