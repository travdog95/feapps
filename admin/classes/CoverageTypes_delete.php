 ...
 * Page class
 */
class CoverageTypes_delete extends CoverageTypes
{
	...
	// Page object name
	public $PageObjName = "CoverageTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("CoverageTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("CoverageTypeslist.php"); // Return to list
			}
		}
	}
