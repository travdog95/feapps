 ...
 * Page class
 */
class WorksheetTemplates_add extends WorksheetTemplates
{
	...
	// Page object name
	public $PageObjName = "WorksheetTemplates_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("WorksheetTemplateslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "WorksheetTemplatesview.php")
