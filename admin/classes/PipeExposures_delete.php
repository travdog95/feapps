 ...
 * Page class
 */
class PipeExposures_delete extends PipeExposures
{
	...
	// Page object name
	public $PageObjName = "PipeExposures_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("PipeExposureslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("PipeExposureslist.php"); // Return to list
			}
		}
	}
