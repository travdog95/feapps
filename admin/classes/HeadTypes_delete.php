 ...
 * Page class
 */
class HeadTypes_delete extends HeadTypes
{
	...
	// Page object name
	public $PageObjName = "HeadTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("HeadTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("HeadTypeslist.php"); // Return to list
			}
		}
	}
