 ...
 * Page class
 */
class JobDefaultTypes_delete extends JobDefaultTypes
{
	...
	// Page object name
	public $PageObjName = "JobDefaultTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("JobDefaultTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("JobDefaultTypeslist.php"); // Return to list
			}
		}
	}
