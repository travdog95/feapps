 ...
 * Page class
 */
class BondRates_delete extends BondRates
{
	...
	// Page object name
	public $PageObjName = "BondRates_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("BondRateslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("BondRateslist.php"); // Return to list
			}
		}
	}
