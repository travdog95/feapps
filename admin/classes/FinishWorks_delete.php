 ...
 * Page class
 */
class FinishWorks_delete extends FinishWorks
{
	...
	// Page object name
	public $PageObjName = "FinishWorks_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("FinishWorkslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("FinishWorkslist.php"); // Return to list
			}
		}
	}
