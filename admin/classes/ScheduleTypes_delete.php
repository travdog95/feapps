 ...
 * Page class
 */
class ScheduleTypes_delete extends ScheduleTypes
{
	...
	// Page object name
	public $PageObjName = "ScheduleTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ScheduleTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ScheduleTypeslist.php"); // Return to list
			}
		}
	}
