 ...
 * Page class
 */
class FirePumpAttributes_delete extends FirePumpAttributes
{
	...
	// Page object name
	public $PageObjName = "FirePumpAttributes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("FirePumpAttributeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("FirePumpAttributeslist.php"); // Return to list
			}
		}
	}
