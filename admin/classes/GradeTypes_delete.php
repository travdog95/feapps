 ...
 * Page class
 */
class GradeTypes_delete extends GradeTypes
{
	...
	// Page object name
	public $PageObjName = "GradeTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("GradeTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("GradeTypeslist.php"); // Return to list
			}
		}
	}
