 ...
 * Page class
 */
class EstimateTypes_delete extends EstimateTypes
{
	...
	// Page object name
	public $PageObjName = "EstimateTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("EstimateTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("EstimateTypeslist.php"); // Return to list
			}
		}
	}
