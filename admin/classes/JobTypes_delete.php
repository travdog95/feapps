 ...
 * Page class
 */
class JobTypes_delete extends JobTypes
{
	...
	// Page object name
	public $PageObjName = "JobTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("JobTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("JobTypeslist.php"); // Return to list
			}
		}
	}
