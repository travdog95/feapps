 ...
 * Page class
 */
class CartParms_delete extends CartParms
{
	...
	// Page object name
	public $PageObjName = "CartParms_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("CartParmslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("CartParmslist.php"); // Return to list
			}
		}
	}
