 ...
 * Page class
 */
class PipeTypes_delete extends PipeTypes
{
	...
	// Page object name
	public $PageObjName = "PipeTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("PipeTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("PipeTypeslist.php"); // Return to list
			}
		}
	}
