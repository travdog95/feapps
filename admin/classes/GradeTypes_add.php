 ...
 * Page class
 */
class GradeTypes_add extends GradeTypes
{
	...
	// Page object name
	public $PageObjName = "GradeTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("GradeTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "GradeTypesview.php")
