 ...
 * Page class
 */
class VolumeCorrections_add extends VolumeCorrections
{
	...
	// Page object name
	public $PageObjName = "VolumeCorrections_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("VolumeCorrectionslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "VolumeCorrectionsview.php")
