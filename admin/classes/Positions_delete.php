 ...
 * Page class
 */
class Positions_delete extends Positions
{
	...
	// Page object name
	public $PageObjName = "Positions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Positionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Positionslist.php"); // Return to list
			}
		}
	}
