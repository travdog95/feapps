 ...
 * Page class
 */
class SystemTypes_delete extends SystemTypes
{
	...
	// Page object name
	public $PageObjName = "SystemTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("SystemTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("SystemTypeslist.php"); // Return to list
			}
		}
	}
