 ...
 * Page class
 */
class FinishWorks_add extends FinishWorks
{
	...
	// Page object name
	public $PageObjName = "FinishWorks_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("FinishWorkslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "FinishWorksview.php")
