 ...
 * Page class
 */
class FinishTypes_delete extends FinishTypes
{
	...
	// Page object name
	public $PageObjName = "FinishTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("FinishTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("FinishTypeslist.php"); // Return to list
			}
		}
	}
