 ...
 * Page class
 */
class CoverageTypes_add extends CoverageTypes
{
	...
	// Page object name
	public $PageObjName = "CoverageTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("CoverageTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "CoverageTypesview.php")
