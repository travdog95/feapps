 ...
 * Page class
 */
class WorksheetColumns_add extends WorksheetColumns
{
	...
	// Page object name
	public $PageObjName = "WorksheetColumns_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("WorksheetColumnslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "WorksheetColumnsview.php")
