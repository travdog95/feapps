 ...
 * Page class
 */
class AdjustmentFactors_delete extends AdjustmentFactors
{
	...
	// Page object name
	public $PageObjName = "AdjustmentFactors_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("AdjustmentFactorslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("AdjustmentFactorslist.php"); // Return to list
			}
		}
	}
