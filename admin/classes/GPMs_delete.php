 ...
 * Page class
 */
class GPMs_delete extends GPMs
{
	...
	// Page object name
	public $PageObjName = "GPMs_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("GPMslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("GPMslist.php"); // Return to list
			}
		}
	}
