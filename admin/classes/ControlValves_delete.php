 ...
 * Page class
 */
class ControlValves_delete extends ControlValves
{
	...
	// Page object name
	public $PageObjName = "ControlValves_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ControlValveslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ControlValveslist.php"); // Return to list
			}
		}
	}
