 ...
 * Page class
 */
class RiserTypes_add extends RiserTypes
{
	...
	// Page object name
	public $PageObjName = "RiserTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("RiserTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "RiserTypesview.php")
