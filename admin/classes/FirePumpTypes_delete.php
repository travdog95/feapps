 ...
 * Page class
 */
class FirePumpTypes_delete extends FirePumpTypes
{
	...
	// Page object name
	public $PageObjName = "FirePumpTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("FirePumpTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("FirePumpTypeslist.php"); // Return to list
			}
		}
	}
