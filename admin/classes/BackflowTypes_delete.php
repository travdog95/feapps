 ...
 * Page class
 */
class BackflowTypes_delete extends BackflowTypes
{
	...
	// Page object name
	public $PageObjName = "BackflowTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("BackflowTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("BackflowTypeslist.php"); // Return to list
			}
		}
	}
