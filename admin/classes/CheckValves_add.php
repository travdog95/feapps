 ...
 * Page class
 */
class CheckValves_add extends CheckValves
{
	...
	// Page object name
	public $PageObjName = "CheckValves_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("CheckValveslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "CheckValvesview.php")
