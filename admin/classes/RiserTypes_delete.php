 ...
 * Page class
 */
class RiserTypes_delete extends RiserTypes
{
	...
	// Page object name
	public $PageObjName = "RiserTypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("RiserTypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("RiserTypeslist.php"); // Return to list
			}
		}
	}
