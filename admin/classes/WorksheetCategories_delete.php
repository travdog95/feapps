 ...
 * Page class
 */
class WorksheetCategories_delete extends WorksheetCategories
{
	...
	// Page object name
	public $PageObjName = "WorksheetCategories_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("WorksheetCategorieslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("WorksheetCategorieslist.php"); // Return to list
			}
		}
	}
