 ...
 * Page class
 */
class ShopFabricationMultipliers_add extends ShopFabricationMultipliers
{
	...
	// Page object name
	public $PageObjName = "ShopFabricationMultipliers_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ShopFabricationMultiplierslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ShopFabricationMultipliersview.php")
