 ...
 * Page class
 */
class HangerSubTypes_grid extends HangerSubTypes
{
	...
	// Page object name
	public $PageObjName = "HangerSubTypes_grid";

	// Grid form hidden field names
	public $FormName = "fHangerSubTypesgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function setRecordKey(&$key, $rs)
	{
		...
		if ($key != "")
			$key .= Config("COMPOSITE_KEY_SEPARATOR");
		$key .= $rs->fields('HangerSubType_Idn');
	}
...
// Render list options (extended codes)
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($keys[0]) != "")
				$this->HangerSubType_Idn->OldValue = strval($keys[0]); // HangerSubType_Idn
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "HangerTypes") {
			...
			if ($GLOBALS["HangerTypes"]->EventCancelled)
