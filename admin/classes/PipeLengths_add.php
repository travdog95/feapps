 ...
 * Page class
 */
class PipeLengths_add extends PipeLengths
{
	...
	// Page object name
	public $PageObjName = "PipeLengths_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("PipeLengthslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "PipeLengthsview.php")
