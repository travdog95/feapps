 ...
 * Page class
 */
class Manufacturers_delete extends Manufacturers
{
	...
	// Page object name
	public $PageObjName = "Manufacturers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Manufacturerslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Manufacturerslist.php"); // Return to list
			}
		}
	}
