 ...
 * Page class
 */
class WorksheetTemplates_delete extends WorksheetTemplates
{
	...
	// Page object name
	public $PageObjName = "WorksheetTemplates_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("WorksheetTemplateslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("WorksheetTemplateslist.php"); // Return to list
			}
		}
	}
