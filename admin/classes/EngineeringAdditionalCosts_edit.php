 ...
 * Page class
 */
class EngineeringAdditionalCosts_edit extends EngineeringAdditionalCosts
{
	...
	// Page object name
	public $PageObjName = "EngineeringAdditionalCosts_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("EngineeringAdditionalCost_Idn") !== NULL) {
				...
				$this->EngineeringAdditionalCost_Idn->setOldValue($this->EngineeringAdditionalCost_Idn->QueryStringValue);
			} elseif (Key(0) !== NULL) {
				...
				$this->EngineeringAdditionalCost_Idn->setOldValue($this->EngineeringAdditionalCost_Idn->FormValue);
			} elseif (Route(2) !== NULL) {
				$this->EngineeringAdditionalCost_Idn->setQueryStringValue(Route(2));
				$this->EngineeringAdditionalCost_Idn->setOldValue($this->EngineeringAdditionalCost_Idn->QueryStringValue);
			} else {
			...
			if (Post("action") !== NULL) {
				...
				// Load key from Form
				if ($CurrentForm->hasValue("x_EngineeringAdditionalCost_Idn")) {
					$this->EngineeringAdditionalCost_Idn->setFormValue($CurrentForm->getValue("x_EngineeringAdditionalCost_Idn"));
				}
			} else {
			...
			if ($this->TotalRecords <= 0) { // No record found
				...
				if ($this->EngineeringAdditionalCost_Idn->CurrentValue != NULL) {
					while (!$rs->EOF) {
						if (SameString($this->EngineeringAdditionalCost_Idn->CurrentValue, $rs->fields('EngineeringAdditionalCost_Idn'))) {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->EngineeringAdditionalCost_Idn->IsDetailKey)
