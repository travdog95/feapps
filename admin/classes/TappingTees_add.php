 ...
 * Page class
 */
class TappingTees_add extends TappingTees
{
	...
	// Page object name
	public $PageObjName = "TappingTees_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("TappingTeeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "TappingTeesview.php")
