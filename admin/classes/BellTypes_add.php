 ...
 * Page class
 */
class BellTypes_add extends BellTypes
{
	...
	// Page object name
	public $PageObjName = "BellTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("BellTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "BellTypesview.php")
