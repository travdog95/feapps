 ...
 * Page class
 */
class BackflowTypes_add extends BackflowTypes
{
	...
	// Page object name
	public $PageObjName = "BackflowTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("BackflowTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "BackflowTypesview.php")
