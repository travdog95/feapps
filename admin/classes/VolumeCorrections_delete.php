 ...
 * Page class
 */
class VolumeCorrections_delete extends VolumeCorrections
{
	...
	// Page object name
	public $PageObjName = "VolumeCorrections_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("VolumeCorrectionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("VolumeCorrectionslist.php"); // Return to list
			}
		}
	}
