 ...
 * Page class
 */
class ShopFabrications_delete extends ShopFabrications
{
	...
	// Page object name
	public $PageObjName = "ShopFabrications_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ShopFabricationslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ShopFabricationslist.php"); // Return to list
			}
		}
	}
