 ...
 * Page class
 */
class ScheduleTypes_add extends ScheduleTypes
{
	...
	// Page object name
	public $PageObjName = "ScheduleTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ScheduleTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ScheduleTypesview.php")
