 ...
 * Page class
 */
class Manufacturers_add extends Manufacturers
{
	...
	// Page object name
	public $PageObjName = "Manufacturers_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("Manufacturerslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "Manufacturersview.php")
