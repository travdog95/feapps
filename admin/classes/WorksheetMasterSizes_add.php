 ...
 * Page class
 */
class WorksheetMasterSizes_add extends WorksheetMasterSizes
{
	...
	// Page object name
	public $PageObjName = "WorksheetMasterSizes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("WorksheetMasterSizeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "WorksheetMasterSizesview.php")
