 ...
 * Page class
 */
class FirePumpAttributes_add extends FirePumpAttributes
{
	...
	// Page object name
	public $PageObjName = "FirePumpAttributes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("FirePumpAttributeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "FirePumpAttributesview.php")
