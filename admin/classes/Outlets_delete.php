 ...
 * Page class
 */
class Outlets_delete extends Outlets
{
	...
	// Page object name
	public $PageObjName = "Outlets_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Outletslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Outletslist.php"); // Return to list
			}
		}
	}
