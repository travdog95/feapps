 ...
 * Page class
 */
class Fittings_delete extends Fittings
{
	...
	// Page object name
	public $PageObjName = "Fittings_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Fittingslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Fittingslist.php"); // Return to list
			}
		}
	}
