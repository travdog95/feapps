 ...
 * Page class
 */
class HeadTypes_add extends HeadTypes
{
	...
	// Page object name
	public $PageObjName = "HeadTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("HeadTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "HeadTypesview.php")
