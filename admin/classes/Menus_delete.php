 ...
 * Page class
 */
class Menus_delete extends Menus
{
	...
	// Page object name
	public $PageObjName = "Menus_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Menuslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Menuslist.php"); // Return to list
			}
		}
	}
