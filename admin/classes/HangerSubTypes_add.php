 ...
 * Page class
 */
class HangerSubTypes_add extends HangerSubTypes
{
	...
	// Page object name
	public $PageObjName = "HangerSubTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("HangerSubTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "HangerSubTypesview.php")
