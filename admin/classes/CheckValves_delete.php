 ...
 * Page class
 */
class CheckValves_delete extends CheckValves
{
	...
	// Page object name
	public $PageObjName = "CheckValves_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("CheckValveslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("CheckValveslist.php"); // Return to list
			}
		}
	}
