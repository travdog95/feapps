 ...
 * Page class
 */
class FirePumpTypes_add extends FirePumpTypes
{
	...
	// Page object name
	public $PageObjName = "FirePumpTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("FirePumpTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "FirePumpTypesview.php")
