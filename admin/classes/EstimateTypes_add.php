 ...
 * Page class
 */
class EstimateTypes_add extends EstimateTypes
{
	...
	// Page object name
	public $PageObjName = "EstimateTypes_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("EstimateTypeslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "EstimateTypesview.php")
