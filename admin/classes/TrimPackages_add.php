 ...
 * Page class
 */
class TrimPackages_add extends TrimPackages
{
	...
	// Page object name
	public $PageObjName = "TrimPackages_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("TrimPackageslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "TrimPackagesview.php")
