...
*/
	...
	function ErrorNo()
	{
		if (!$this->_connectionID) return 0; //***
		$errc = $this->_connectionID->Errors;
			...
			switch($t) {
				...
				case 7: // adDate
					if (!strlen((string)$f->value)) $this->fields[] = false;
							...
							if (($val % 86400) == 0)
								$this->fields[] = adodb_date('Y-m-d', $val, EW_ADODB_TZ_OFFSET); //***
							else
								$this->fields[] = adodb_date('Y-m-d H:i:s', $val, EW_ADODB_TZ_OFFSET); //***
					}
					break;
				case 1: // null
					$this->fields[] = false;
				...
				case 146: // datetimeoffset //***
					$this->fields[] = null; // not supported
					break;
				default:
					$this->fields[] = $f->value;
					break;
