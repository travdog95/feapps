...
<div class="custom-control custom-checkbox d-inline-block">
	<input type="checkbox" class="custom-control-input" data-table="Outlets" data-field="x_ActiveFlag" name="x_ActiveFlag[]" id="x_ActiveFlag[]_566669" value="1"<?php echo $selwrk ?><?php echo $Outlets_edit->ActiveFlag->editAttributes() ?>>
	<label class="custom-control-label" for="x_ActiveFlag[]_566669"></label>
</div>
</span>
