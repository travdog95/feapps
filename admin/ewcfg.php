...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "feapps51"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'r3z7eaT3WmXf65L2', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/feapps51.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{F9BE56C1-2B96-4EAD-A4B7-9962C6BB1A43}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MSSQL", "qs" => "[", "qe" => "]", "host" => "wisp-dev2016", "port" => NULL, "user" => "sa", "pass" => "TkoConsulting1", "db" => "feapps51"]
	],
	...
	"ADMIN_PASSWORD" => "Onfire!", // Administrator password
	...
	"USER_TABLE_NAME" => "v_Administrators",
	...
	// User table filters
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "[dbo].[v_Administrators]",
