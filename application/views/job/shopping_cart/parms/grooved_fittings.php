...
//Fitting Type
//$fitting_types = $this->m_reference_table->get_where("GroovedFittingTypes", "ActiveFlag = 1", "Rank ASC");
//$this->load->view("job/shopping_cart/parms/parm_components/grooved_fitting_type.php", array("id" => $id, "fitting_types" => $fitting_types, "label" => "Fitting Type")); 

//Sizes
$sizes = ($worksheet_master['Department_Idn'] == 2) ? $this->m_reference_table->get_where("ProductSizes", "Value >= '1.0' AND Value <= '12.0' AND Department_Idn IN (2,3)", "Value ASC") : $worksheet_master['WorksheetMasterSizes']; 
