...
<div class="row">
    <div class="col-md-12">
    <button type="button" class="btn btn-secondary delete_jobs"><span class="glyphicon glyphicon-trash glyphicon-xs" title="Delete selected jobs" aria-hidden="true"></span></button>
    </div>
</div>
