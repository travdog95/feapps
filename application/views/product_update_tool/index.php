    ...
    <div class="main-content">        
        <div class="container">
            ...
            <div class="row">
				...
				<?php
				$column_headers = array('ID', 'Product Name', 'FECI ID', 'Manufacturer Part ID', 'Material','Field','Shop','Design','Department','Worksheet','Category','Pipe Type','Schedule Type', 'RFP');
				$num_rows_staging = 0;
				?>
                <div class="col-md-12">
