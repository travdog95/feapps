<form class="form-horizontal product-tab">
  <div class="form-group form-group-sm">
    <label for="Product_Idn" class="col-sm-3 control-label">ID</label>
    <div class="col-sm-9">
        <p class="form-control-static"><?php echo $product['Product_Idn']; ?></p>
    </div>
  </div>
  <div class="form-group form-group-sm">
    <label for="Department_Idn" class="col-sm-3 control-label">Department</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="WorksheetMaster_Idn" class="col-sm-3 control-label">Worksheet Master</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="WorksheetCategory_Idn" class="col-sm-3 control-label">Worksheet Category</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="Manufacturer_Idn" class="col-sm-3 control-label">Manufacturer</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="MaterialUnitPrice" class="col-sm-3 control-label">Material Unit Price</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="ProductSize_Idn" class="col-sm-3 control-label">Product Size</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="PipeType_Idn" class="col-sm-3 control-label">Pipe Type</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="ScheduleType_Idn" class="col-sm-3 control-label">Schedule Type</label>
    <div class="col-sm-9">
  ...
  <div class="form-group form-group-sm">
    <label for="ActiveFlag" class="col-sm-3 control-label">Active?</label>
    <div class="col-sm-9">
      <div class="checkbox">
        <label>
    ...
    <!-- <div class="form-group form-group-sm">
        <label for="ResponseType" class="col-sm-3 control-label">Description</label>
        <div class="col-sm-9">
        <textarea class="form-control" rows="3" placeholder="Description"></textarea>
        </div>
    </div>
  <div class="form-group form-group-sm">
  <label for="ResponseType" class="col-sm-3 control-label">Response Type</label>
    <div class="col-sm-9">
        <label class="radio-inline">
            <input type="radio" name="ResponseType" id="ResponseTypeQR" value="QR" checked> QR
        </label>
        <label class="radio-inline">
            <input type="radio" name="ResponseType" id="ResponseTypeSR" value="SR"> SR
        </label>    
    </div>
  </div> -->

  <!-- <div class="form-group form-group-sm">
    <label for="ApplyToAdjustmentFactorsFlag" class="col-sm-3 control-label">Apply To Adjustment Factors Flag</label>
    <div class="col-sm-9">
      <div class="checkbox">
        <label>
          <input name="ApplyToAdjustmentFactorsFlag" id="ApplyToAdjustmentFactorsFlag" type="checkbox"> 
        </label>
      </div>
    </div>
  </div> -->
